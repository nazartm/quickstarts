...
import tutorial.api.v1.service.BlogRestfulService;
...
@Named
@Scope("request")
public class BlogRestfulServiceV1 implements BlogRestfulService {

    private BlogService service;
    private Mapper mapper;

    @Autowired
    public BlogRestfulServiceV1(BlogService service, Mapper mapper) {
